...
export function Pricing() {
  const plans = [
    ...
    },
    {
      ...
      setupFee: '+ $49.000 + IVA /mes por el software',
      features: [
            ...
            >
              ...
              <div className="mb-8">
                <div className="flex items-baseline flex-wrap">
                  <span className={`${plan.price.includes('Desde') || plan.price.includes('A medida') ? 'text-3xl' : 'text-4xl'} font-extrabold`}>{plan.price}</span>
              ...
              <a 
                ...
                className={`w-full py-4 px-6 rounded-xl font-bold transition-all text-center block ${
                  plan.highlighted
