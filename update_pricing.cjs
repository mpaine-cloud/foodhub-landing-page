...
export function Pricing() {
  const plans = [
    ...
    },
    {
      ...
      price: '$49.000',
      period: '/mes',
      setupFee: '+ desde $500.000 (pago único por asesoría)',
      features: [
    ...
    },
    {
      ...
      price: '$49.000',
      period: '/mes',
      setupFee: '+ a medida (pago único por consultoría)',
      features: [
          ...
          {plans.map((plan, index) => (
            ...
            >
              ...
              <div className="mb-8">
                ...
                {plan.setupFee && (
                  <div className={\`mt-3 text-xs font-medium \${plan.highlighted ? 'text-[#10b981] bg-[#10b981]/10 px-3 py-1.5 rounded-lg inline-block border border-[#10b981]/20' : 'text-emerald-400 bg-emerald-400/10 px-3 py-1.5 rounded-lg inline-block border border-emerald-400/20'}\`}>
                    {plan.setupFee}
                  </div>
                )}
              </div>
